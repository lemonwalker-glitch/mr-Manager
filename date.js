...
function next(){
  if (confirm("All unsaved progress will be lost!"))  {
    ...
    var newSunday = checkOverflow(date_Master.sunday.nextSunday, date_Master.Sunday.month, date_Master.Sunday.year, date_Master.daysInMonth);
...
function previous() {
  if (confirm("All unsaved progress will be lost!")) {
    ...
    var newSunday = checkUnderFlow(date_Master.sunday.nextSunday, date_Master.Sunday.month, date_Master.Sunday.year)
